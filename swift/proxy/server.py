...
class Application(object):
    ...
    def __init__(self, conf, memcache=None, logger=None, account_ring=None,
        ...
        self.expose_swift_info = config_true_value(
            conf.get('expose_info', 'no'))
    ...
    def get_controller(self, path):
        ...
        """
        if path == '/info':
            d = dict(expose_swift_info=self.expose_swift_info,
    ...
    def handle_request(self, req):
        ...
        try:
            ...
            if 'version' in path_parts and path_parts['version']:
                req.path_info_pop()
