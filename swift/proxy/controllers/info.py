...
class InfoController(Controller):
    ...
    def __init__(self, app, expose_swift_info, disallowed_sections, admin_key):
        Controller.__init__(self, app)
        self.expose_swift_info = expose_swift_info
    ...
    def GETorHEAD(self, req):
        ...
        if sig != '' or expires != '':
            ...
            if expires < time():
                return HTTPUnauthorized(request=req)
            valid_sig = get_hmac(req.environ['REQUEST_METHOD'],
        ...
        info = get_swift_info(admin=admin_request,
